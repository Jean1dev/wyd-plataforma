...
import { WorldEventConfigTool } from "./_components/WorldEventConfigTool";

const wrap: React.CSSProperties = { maxWidth: 1320, margin: "0 auto", padding: "32px 24px 72px" };

export default async function AdminWorldEventsPage() {
  ...
  return (
    <div className="wyd-screen" style={wrap}>
      <AdminHeader eyebrow="Moderação" title="Eventos Globais" />
      <WorldEventConfigTool />
    </div>
  );
}
