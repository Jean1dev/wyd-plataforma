...
import { AttributeMapTool } from "./_components/AttributeMapTool";

const wrap: React.CSSProperties = { maxWidth: 1320, margin: "0 auto", padding: "32px 24px 72px" };

export default async function AdminAttributeMapPage() {
  ...
  return (
    <div className="wyd-screen" style={wrap}>
      <AdminHeader eyebrow="Moderação" title="AttributeMap Editor" />
      <AttributeMapTool />
    </div>
  );
}
